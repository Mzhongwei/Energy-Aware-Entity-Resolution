...
output: walk sequences for embedding training [transfer]
"""

GRAPH_FILE_NAME = "graph.graphml"
INPUT_DATA_TYPE = "embedding"
INPUT_FILE_NAME = "training_dyn_roots.json"
OUTPUT_DATA_TYPE = "embedding"
OUTPUT_FILE_NAME = "training_sequences"
OUTPUT_EXTENSION = "json"

def main():
    parser = argparse.ArgumentParser(description="Batch entry for training random walk.")
